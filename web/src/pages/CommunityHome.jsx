  ...
  return (
    <>
      <div className="grid grid-cols-3 gap-3 justify-items-center mt-8">
        <NavLink to="/communities/:id/claims">
        ...
        <NavLink to="/communities/:id/forumTopics">
          <div className='mb-5'>
        ...
        <NavLink to="/communities/:id/contacts">
          <div className='mb-5'>
        ...
        <NavLink to="/communities/:id/reservations">
          <div className='mb-5'>
        ...
        <NavLink to="/communities/:id/users/:userId">
          <div className='mb-5'>
