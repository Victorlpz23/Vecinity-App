...
function Home() {
  ...
  return (
    ...
    <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div className="flex flex-col w-full  lg:w-full justify-center items-start text-center md:text-left pb-40">
        ...
        <button className="mx-auto lg:mx-60 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
          Sign up
        </button>
      </div>
    </div>
      ...
      <div className="flex flex-wrap">
        ...
        <div className="flex flex-wrap">
          <div className="w-5/6 sm:w-1/2 p-6 ">
            ...
            <p className="text-gray-600 mb-8">
              With the social community forum you can share aything with your neighbours, from plans to extra food or goodies you might have.
              <br />
              <br />
            </p>
          </div>
  ...
  <section className="mx-auto text-center py-20 mb-8 gradient-bg">
    ...
    <button className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-6 mb-0 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
      Sign up
    </button>
  </section>
</>
