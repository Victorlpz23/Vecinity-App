            ...
            focus:border-red-500 block w-full p-2.5 dark:bg-red-100 dark:border-red-400` : ''}`} id="confirm-password"
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label for="terms" className="font-light text-gray-500 dark:text-gray-300">I accept the <a className="font-medium text-green hover:underline dark:text-primary-500" href="/">Terms and Conditions</a></label>
                  </div>
                </div>
