      ...
      <footer className="fixed bottom-0 left-0 z-20 w-full p-0 bg-white  md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
        {user?.community ? (
          ...
          <div class="grid h-full max-w-lg grid-cols-3 mx-auto border-b">
            ...
            <Link to={`/communities/${user?.community}`} class="inline-flex flex-col items-center justify-center px-5 border-gray-200 border-x hover:bg-gray-50 dark:hover:bg-gray-800 group dark:border-gray-600">
            ...
            <Link to={`/communities/${user?.community}/events`} class="inline-flex flex-col items-center justify-center font-medium px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            ...
            <Link to={`/communities/${user?.community}/users/${user?.id}/settings`} type="button" class="inline-flex flex-col items-center justify-center px-5 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 group border-x dark:border-gray-600">
