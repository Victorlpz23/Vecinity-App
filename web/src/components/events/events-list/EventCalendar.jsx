        ...
        <div class="max-w-sm w-full rounded-lg shadow-orange shadow-sm">
          <div class="md:p-8 p-5 dark:bg-gray-800 bg-white rounded-t">
            <div class="px-4 flex items-center justify-between">
              ...
              <button type="button" class="focus:outline-none text-white bg-orange hover:bg-orange focus:ring-4 focus:ring-red-300 font-medium rounded-lg  mt-3 text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-orange dark:hover:bg-orange dark:focus:ring-orange">+</button>
          ...
          <div class="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-gray-50 rounded-b">
            <div class="px-4">
              <div class="border-b pb-4 border-gray-400 border-dashed">
                ...
                <a tabindex="0" class="focus:outline-none text-lg font-medium leading-5 text-gray-800 dark:text-gray-100 mt-2">Reunión de Vecinos</a>
                <p class="text-sm pt-2 leading-4 leading-none text-gray-600 dark:text-gray-300">Discusion sobre la nueva fachada</p>
              </div>
              <div class="border-b pb-4 border-gray-400 border-dashed pt-5">
                ...
                <a tabindex="0" class="focus:outline-none text-lg font-medium leading-5 text-gray-800 dark:text-gray-100 mt-2">Votación de la acometida</a>
              </div>
            </div>
          </div>
        </div>
